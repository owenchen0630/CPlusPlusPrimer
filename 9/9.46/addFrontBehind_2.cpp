...
string addFrontBehind_2(string name, string &frontT, string &behindT) {
	name.insert(0, frontT);
	name.insert(name.size(), behindT);
	return name;
}
...
int main() {
	...
	string fullName = addFrontBehind_2(name, frontT, behindT);
	cout << s << endl;
	cout << name<<endl;
	cout << fullName << endl;
	system("pause");
